...
const translations = {
  en: {
    ...
    test_2_quote: '"Chefchaouen blew our minds. The blue streets, the mountain hikes, and the incredible food \u2014 Authentic Morocco Tour planned every detail perfectly."',
    test_2_name: "Jean D.",
    ...
    tour_6_name: "3-Day Marrakech to Coast",
    tour_6_f1: "✓ Scenic drive to Essaouira",
    tour_6_f2: "✓ Explore historic Medina & port",
    tour_6_f3: "✓ Travel Atlantic coast to Agadir",
    tour_6_f4: "✓ Relax on beautiful beaches",
    tour_7_name: "18-Day Grand Morocco",
    tour_7_f1: "✓ Comprehensive 18-day journey",
    tour_7_f2: "✓ Imperial Cities: Rabat, Meknes, Fes",
    tour_7_f3: "✓ Blue City (Chefchaouen) & Tangier",
    tour_7_f4: "✓ Sahara Desert (Merzouga) experience",
    tour_book: "Book This Tour",
    about_header_title: "Why Authentic Morocco Tour?",
    about_header_sub: "We are a team of passionate Moroccan locals dedicated to sharing the beauty of our homeland.",
    about_p1: "Founded in Marrakech, Authentic Morocco Tour was born from a deep love for Morocco's culture, landscapes, and people. Our team of local guides and travel experts has been crafting unforgettable journeys for over a decade.",
  ...
  fr: {
    ...
    test_2_quote: '"Chefchaouen nous a émerveillés. Les rues bleues, les randonnées et la nourriture incroyable \u2014 Authentic Morocco Tour a planifié chaque détail."',
    test_2_name: "Jean D.",
    test_2_loc: "Paris, France",
    ...
    tour_6_name: "Côte de 3 jours depuis Marrakech",
    tour_6_f1: "✓ Route panoramique vers Essaouira",
    tour_6_f2: "✓ Explorez la médina historique et le port",
    tour_6_f3: "✓ Voyagez sur la côte atlantique jusqu'à Agadir",
    tour_6_f4: "✓ Détendez-vous sur de belles plages",
    tour_7_name: "Grand Maroc en 18 jours",
    tour_7_f1: "✓ Voyage complet de 18 jours",
    tour_7_f2: "✓ Villes impériales : Rabat, Meknès, Fès",
    tour_7_f3: "✓ Ville bleue (Chefchaouen) et Tanger",
    tour_7_f4: "✓ Expérience dans le désert du Sahara (Merzouga)",
    tour_book: "Réserver ce tour",
    about_header_title: "Pourquoi Authentic Morocco Tour ?",
    about_header_sub: "Une équipe de Marocains passionnés, dédiés à partager la beauté de notre pays.",
    about_p1: "Fondée à Marrakech, Authentic Morocco Tour est née d'un amour profond pour la culture, les paysages et les gens du Maroc. Notre équipe crée des voyages inoubliables depuis plus de dix ans.",
  ...
  ar: {
    ...
    tour_5_name: "رحلة 5 أيام في جبال الأطلس",
    tour_5_f1: "✓ رحلة سير مرشدة في الأطلس الكبير",
    tour_5_f2: "✓ مخيم قاعدة جبل توبقال",
    tour_5_f3: "✓ إقامة في قرى أمازيغية أصلية",
    tour_5_f4: "✓ بغال لنقل الأمتعة ومرشد محلي",
    tour_6_name: "3 أيام من مراكش إلى الساحل",
    tour_6_f1: "✓ قيادة ذات مناظر خلابة إلى الصويرة",
    tour_6_f2: "✓ استكشف المدينة التاريخية والميناء",
    tour_6_f3: "✓ السفر عبر ساحل المحيط الأطلسي إلى أكادير",
    tour_6_f4: "✓ الاسترخاء على الشواطئ الجميلة",
    ...
    about_header_title: "لماذا Authentic Morocco Tour؟",
    about_header_sub: "فريق من المغاربة الشغوفين المكرسين لمشاركة جمال وطننا.",
    about_p1: "تأسست Authentic Morocco Tour في مراكش من حب عميق لثقافة المغرب ومناظره وأهله. فريقنا يصمم رحلات لا تُنسى منذ أكثر من عقد.",
  ...
  nl: {
    ...
    test_2_quote: '"Chefchaouen blies ons omver. De blauwe straten, de bergwandelingen en het ongelooflijke eten — Authentic Morocco Tour plantte elk detail perfect."',
    test_2_name: "Jean D.",
    ...
    tour_6_name: "3-Daagse kusttour vanuit Marrakech",
    tour_6_f1: "✓ Panoramische rit naar Essaouira",
    tour_6_f2: "✓ Verken de historische medina en haven",
    tour_6_f3: "✓ Reis langs de Atlantische kust naar Agadir",
    tour_6_f4: "✓ Ontspan op prachtige stranden",
    tour_7_name: "18-Daagse Grand Marokko Tour",
    tour_7_f1: "✓ Uitgebreide reis van 18 dagen",
    tour_7_f2: "✓ Keizerlijke steden: Rabat, Meknes, Fes",
    tour_7_f3: "✓ Blauwe Stad (Chefchaouen) & Tanger",
    tour_7_f4: "✓ Sahara Woestijn (Merzouga) ervaring",
    tour_book: "Boek deze tour",
    about_header_title: "Waarom Authentic Morocco Tour?",
    ...
    about_p1: "Authentic Morocco Tour werd opgericht in Marrakesh vanuit een diepe liefde voor de cultuur, landschappen en mensen van Marokko. Ons team van lokale gidsen en reisexperts maakt al meer dan tien jaar onvergetelijke reizen.",
  ...
  de: {
    ...
    test_1_name: "Sarah M.",
    test_1_loc: "London, UK",
    test_2_quote: '"Chefchaouen hat uns umgehauen. Die blauen Gassen, die Bergwanderungen und das unglaubliche Essen — Authentic Morocco Tour hat jedes Detail perfekt geplant."',
    test_2_name: "Jean D.",
    ...
    tour_6_name: "3-Tägige Küstentour ab Marrakesch",
    tour_6_f1: "✓ Landschaftlich reizvolle Fahrt nach Essaouira",
    tour_6_f2: "✓ Erkunden Sie die historische Medina und den Hafen",
    tour_6_f3: "✓ Fahrt entlang der Atlantikküste nach Agadir",
    tour_6_f4: "✓ Entspannen Sie an wunderschönen Stränden",
    tour_7_name: "18-Tägige Große Marokko-Tour",
    tour_7_f1: "✓ Umfassende 18-tägige Reise",
    tour_7_f2: "✓ Königsstädte: Rabat, Meknès, Fès",
    tour_7_f3: "✓ Blaue Stadt (Chefchaouen) & Tanger",
    tour_7_f4: "✓ Sahara Wüste (Merzouga) Erlebnis",
    tour_book: "Diese Tour buchen",
    about_header_title: "Warum Authentic Morocco Tour?",
    ...
    about_p1: "Authentic Morocco Tour wurde in Marrakesch aus tiefer Liebe zur Kultur, den Landschaften und Menschen Marokkos gegründet. Unser Team lokaler Guides und Reiseexperten gestaltet seit über einem Jahrzehnt unvergessliche Reisen.",
  ...
  it: {
    ...
    test_2_quote: '"Chefchaouen ci ha stupito. Le strade blu, le escursioni in montagna e il cibo incredibile — Authentic Morocco Tour ha curato ogni dettaglio alla perfezione."',
    test_2_name: "Jean D.",
    ...
    tour_6_name: "Tour della costa di 3 giorni da Marrakech",
    tour_6_f1: "✓ Viaggio panoramico verso Essaouira",
    tour_6_f2: "✓ Esplora la storica Medina e il porto",
    tour_6_f3: "✓ Viaggia lungo la costa atlantica fino ad Agadir",
    tour_6_f4: "✓ Rilassati su bellissime spiagge",
    tour_7_name: "Gran Tour del Marocco di 18 giorni",
    tour_7_f1: "✓ Viaggio completo di 18 giorni",
    tour_7_f2: "✓ Città imperiali: Rabat, Meknès, Fès",
    tour_7_f3: "✓ Città blu (Chefchaouen) e Tangeri",
    tour_7_f4: "✓ Esperienza nel deserto del Sahara (Merzouga)",
    tour_book: "Prenota questo tour",
    about_header_title: "Perché Authentic Morocco Tour?",
    about_header_sub: "Siamo un team di appassionati locali marocchini dediti a condividere la bellezza della nostra terra.",
    about_p1: "Fondata a Marrakech, Authentic Morocco Tour è nata da un profondo amore per la cultura, i paesaggi e le persone del Marocco. Il nostro team di guide locali ed esperti di viaggio crea viaggi indimenticabili da oltre un decennio.",
